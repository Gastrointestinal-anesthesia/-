...
const char* fileName="/home/lab129/音乐/tts_sample.wav";
const char* playPath="play /home/lab129/音乐/tts_sample.wav";
...
{
        int ret=MSP_SUCCESS;
    const char* login_params="appid = 62005a19, work_dir = .";//登录参数,appid与msc库绑定,请勿随意改动
    /*
    * rdn:           合成音频数字发音方式
